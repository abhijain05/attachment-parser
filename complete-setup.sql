-- Run this entire SQL file on your VPS PostgreSQL as the postgres user or admin
...
CREATE TABLE IF NOT EXISTS "chatbot_configs" (
        ...
        CONSTRAINT "chatbot_configs_project_id_unique" UNIQUE("project_id")
);
...
ALTER TABLE "chatbot_configs" ADD CONSTRAINT "chatbot_configs_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "documents" ADD CONSTRAINT "documents_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."documents"("id") ON DELETE cascade ON UPDATE no action;
...
VALUES 
  ('admin@tarang.dev', '$2a$10$BKx8Kx8bfJ0Z0Kx8Kx8Kex8Kx8KxzKl7ZL0KzL0KzL0KzL0KzL0K', 'email', 'Admin', 'User', true),
  ('demo@tarang.dev', '$2a$10$LK0L0KyL0KyL0KyL0KyL0eL0KyL0KyL0KyL0KyL0KyL0KyL0KyL0K', 'email', 'Demo', 'User', true)
